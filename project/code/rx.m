function [rx_bitstream] = rx(rx_signal, conf)
    ...
    rx_signal_MF = rx_signal(beginning_of_data + os_training_length : beginning_of_data + os_training_length + conf.packet_per_frame * (conf.symb_per_packet * conf.os_factor_ofdm + conf.cp_length) - 1);
