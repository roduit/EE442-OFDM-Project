...
for ii=1:data_length
     ...
     y_hat = int_diff*y(2) + (1-int_diff)*y(1);
     data(ii) = y_hat;
     
     % cubic
     y2 = filtered_rx_signal(idx_start+sample_diff: idx_start+sample_diff+3);
     c = 1/6 * [-1 3 -3 1 ; 3 -6 3 0 ; -2 -3 6 -1 ; 0 6 0 0] * y2;
     y_hat2 = c(1)*int_diff^3 + c(2)*int_diff^2 + c(3)*int_diff^1 +c(4)*int_diff;
     data2(ii) = y_hat2;  
